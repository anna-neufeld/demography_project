...
y2000 <- sqrt(y2000)
y2010 <- sqrt(y2010)
psi2010[,1:13] <- sqrt(psi2010[,1:13])
phi2000[,1:13] <- sqrt(phi2000[,1:13])
...
png('posterior2000.sqrtroot.png')
par(mfrow=c(3,3))
for (age in 1:9) {
  xrange <- c(0:60)
  posteriors <- posterior2000(xrange, age)
  plot(xrange, posteriors, type='l', xlab="Square Root People", ylab="Density", main = paste("Posterior for", names(y2000)[age], ", 2000"))
...
png('posterior2010.sqrtroot.png')
par(mfrow=c(3,3))
for (age in 1:9) {
  xrange <- c(0:60)
  posteriors <- posterior2010(xrange, age)
  plot(xrange, posteriors, type='l', xlab="Square Root People", ylab="Density", main = paste("Posterior for", names(y2010)[age], ", 2010"), cex=0.8)
